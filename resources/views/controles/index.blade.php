...
<div class="container mt-5 p-2 pt-0 rounded w-50 bg-white border border-secondary">
    <h2 class="mt-3 mb-3">Solicitar Número</h2>
    ...
    <form action="{{ route('controles.store')}}" method="post">
        ...
        <textarea class="w-100 rounded mt-2" id="con_observacao" name="con_observacao" rows="3" cols="50" placeholder="Observação"></textarea>
        <div class="m-0">
